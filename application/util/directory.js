...
var Directory = Labs.Service.extend({
    
    initialize: function() { throw new Error('Directory Class cannot be instanciated. All members and methods are declared as static.'); },
